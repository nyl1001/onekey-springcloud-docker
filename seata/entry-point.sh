...
echo "###########################################################"
echo "###########################################################"
nacosStatuCheckUrl="http://nacos-onekey-standalone-s:8848/nacos/v1/cs/configs?dataId=${NACOS_STATUS_CHECK_KEY_FOR_SEATA}&tenant=${COMMON_NACOS_NAMESPACE_FOR_SEATA}&group=${COMMON_NACOS_GROUP_FOR_SEATA}"
